...
-- user-facing 'Cooked.MockChain.Effect.Read.Chain.MockChainReadChain' effect,
-- and they are deliberately not re-exported through the 'Cooked.MockChain'
-- umbrella module.
module Cooked.MockChain.Effect.Read.Conf
...
-- 'Cooked.MockChain.Effect.Read.Chain.MockChainReadChain' effect.
